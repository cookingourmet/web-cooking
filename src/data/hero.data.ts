...
export const heroSlides: HeroSlide[] = [
  ...
  },
  {
    ...
    subtitle: "Conviértete en especialista en coctelería y servicio de barra.",
    description:
  ...
  },
  {
    ...
    subtitle: "Explora el arte del café con estándares de excelencia.",
    description:
  ...
  {
    title: "Sommelier",
    subtitle: "Conocimiento, servicio y cultura del vino en un solo programa.",
    description:
  ...
  },
  {
    ...
    subtitle: "Aprende rápido, práctico y con enfoque laboral.",
    description:
